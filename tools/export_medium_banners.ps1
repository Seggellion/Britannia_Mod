param(
    [string]$IllustratorSource = 'C:\projects\britannia\raw fiels\tabbard\banner_medium.ai',
...
$bannerSpecs = @(
    @{ StableId = 'tournament_medium'; Layer = 'tournament_medium' },
    @{ StableId = 'ceremonial_tournament'; Layer = 'ceremonial_tournament' },
    @{ StableId = 'iron_quarter'; Layer = 'iron_quarter' },
    @{ StableId = 'outer_ward'; Layer = 'outer_ward' },
    @{ StableId = 'ward_of_serpents'; Layer = 'ward_of_serpents' },
    @{ StableId = 'serpent_guard'; Layer = 'serpent_guard' },
    @{ StableId = 'crossroad_guard'; Layer = 'crossroad_guard' },
    @{ StableId = 'argent_shield'; Layer = 'argent_shield' }
)
...
try {
    ...
    $report.document = [ordered]@{
        ...
        clipping_mask_observation = 'Named page-item clipping state is recorded in the hierarchy. The ward_of_serpents dye mask is one unnamed item inside the explicitly named dye_mask child layer.'
...
$reportPath = Join-Path $RepositoryRoot 'content\banner-final-intake\medium_illustrator_report.json'
