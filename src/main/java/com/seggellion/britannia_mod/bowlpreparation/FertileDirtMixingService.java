...
public final class FertileDirtMixingService {
    ...
    public static ApplyResult apply(ServerPlayer player, FertileDirtMixingPlan plan) {
        ...
        BowlPreparationOutput.giveOrDrop(player, fertilizedDirt, InteractionHand.MAIN_HAND);
        BowlPreparationOutput.giveOrDrop(player, returnedBowls, InteractionHand.OFF_HAND);
