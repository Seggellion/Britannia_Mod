...
/** Low, non-colliding world node for the existing Sulphurous Ash reagent item. */
public final class SulphurousAshBlock extends Block implements AdventureHarvestableBlock {
    private static final VoxelShape SHAPE = Block.box(1.0D, 0.0D, 1.0D, 15.0D, 2.0D, 15.0D);

    public SulphurousAshBlock(Properties properties) {
        super(properties);
    }
