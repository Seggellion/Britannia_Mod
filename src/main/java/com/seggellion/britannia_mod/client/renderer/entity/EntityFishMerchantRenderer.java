...
public class EntityFishMerchantRenderer extends GeoEntityRenderer<EntityFishMerchant> {
    ...
    public EntityFishMerchantRenderer(EntityRendererProvider.Context ctx) {
    ...
    public RenderType getRenderType(EntityFishMerchant entity, float partialTick, PoseStack poseStack,
    ...
    @Override
    public void preRender(PoseStack poseStack, EntityFishMerchant entity, BakedGeoModel bakedModel,
