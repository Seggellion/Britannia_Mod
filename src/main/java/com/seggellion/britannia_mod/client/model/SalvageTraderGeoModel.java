...
public class SalvageTraderGeoModel extends GeoModel<SalvageTraderEntity> {

    private static String baseName(SalvageTraderEntity e) {
    ...
    @Override
    public ResourceLocation getModelResource(SalvageTraderEntity e) {
    ...
    @Override
    public ResourceLocation getAnimationResource(SalvageTraderEntity e) {
        String base = baseName(e);
        return ResourceLocation.fromNamespaceAndPath(
