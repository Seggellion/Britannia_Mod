...
public class AlcoholTraderGeoModel extends GeoModel<AlcoholTraderEntity> {

    private static String baseName(AlcoholTraderEntity e) {
    ...
    @Override
    public ResourceLocation getModelResource(AlcoholTraderEntity e) {
    ...
    @Override
    public ResourceLocation getTextureResource(AlcoholTraderEntity e) {
        String base = baseName(e);
    ...
    @Override
    public ResourceLocation getAnimationResource(AlcoholTraderEntity e) {
        String base = baseName(e);
        return ResourceLocation.fromNamespaceAndPath(
