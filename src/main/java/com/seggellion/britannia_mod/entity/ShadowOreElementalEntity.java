...
public class ShadowOreElementalEntity extends Monster implements GeoAnimatable {
    ...
    public ShadowOreElementalEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<ShadowOreElementalEntity>(this, "controller", 20, this::predicate));

    }

    private PlayState predicate(AnimationState<ShadowOreElementalEntity> state) {
        if (state.isMoving()) {
...
protected void registerGoals() {
    ...
    // Spawn conditions
    public static boolean canSpawn(EntityType<ShadowOreElementalEntity> type, ServerLevelAccessor world, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
    ...
    // Sound events for ShadowOreElemental
    @Override
