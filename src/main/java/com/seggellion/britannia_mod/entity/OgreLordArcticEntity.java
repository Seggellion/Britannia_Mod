...
public class OgreLordArcticEntity extends BaseBritanniaMonster {

    public OgreLordArcticEntity(EntityType<? extends Monster> entityType, Level level) {
        // Passing "ogre" automates the loot table, textures, models, animations, AND sounds!
        super(entityType, level, "ogre_lord_arctic");
    }

    // Attributes
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
              .add(Attributes.MAX_HEALTH, 395.0D)
