...
public class GargoyleEnforcerEntity extends BaseBritanniaMonster {

    public GargoyleEnforcerEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "gargoyle_enforcer");
    }
