...
public class EarthElementalEntity extends Monster implements GeoAnimatable {
    ...
    public EarthElementalEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<EarthElementalEntity>(this, "controller", 20, this::predicate));

    }

    private PlayState predicate(AnimationState<EarthElementalEntity> state) {
        if (state.isMoving()) {
...
protected void registerGoals() {
    ...
    // Spawn conditions
    public static boolean canSpawn(EntityType<EarthElementalEntity> type, ServerLevelAccessor world, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
    ...
    // Sound events for EarthElemental
    @Override
