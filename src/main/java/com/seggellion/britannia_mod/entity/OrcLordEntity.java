...
public class OrcLordEntity extends BaseBritanniaMonster {

    public OrcLordEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "orc_lord");
    }

    // Attributes
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, 66.0D)
