...
public class BearGrizzlyEntity extends BaseBritanniaAnimal {

    public BearGrizzlyEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
        super(entityType, level, "bear_grizzly");
    }
