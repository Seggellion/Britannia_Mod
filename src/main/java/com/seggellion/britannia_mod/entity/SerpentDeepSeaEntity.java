...
public class SerpentDeepSeaEntity extends BaseBritanniaMonster {
    ...
    public SerpentDeepSeaEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "serpent_deep_sea");
