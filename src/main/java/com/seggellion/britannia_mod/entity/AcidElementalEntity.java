...
public class AcidElementalEntity extends BaseBritanniaMonster {

    public AcidElementalEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "elemental_acid");
    }
