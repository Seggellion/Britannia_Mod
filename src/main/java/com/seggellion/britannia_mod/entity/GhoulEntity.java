...
public class GhoulEntity extends Monster implements GeoAnimatable {
    ...
    public GhoulEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
       // controllers.add(new AnimationController<GhoulEntity>(this, "controller", 0, this::predicate));
        controllers.add(new AnimationController<GhoulEntity>(this, "controller", 20, this::predicate));

    }

    private PlayState predicate(AnimationState<GhoulEntity> state) {
        if (state.isMoving()) {
    ...
    // Spawn conditions
    public static boolean canSpawn(EntityType<GhoulEntity> type, ServerLevelAccessor world, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
