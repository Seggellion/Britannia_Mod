...
public class GargoyleStoneEntity extends BaseBritanniaMonster {

    public GargoyleStoneEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "gargoyle_stone");
    }
