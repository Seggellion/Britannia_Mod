...
public class LizardmanEntity extends BaseBritanniaMonster {

    public LizardmanEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "lizardman");
    }
