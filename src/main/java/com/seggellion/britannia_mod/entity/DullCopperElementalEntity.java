...
public class DullCopperElementalEntity extends BaseBritanniaMonster {

    public DullCopperElementalEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "elemental_dull_copper");
    }
