...
public class RatmanAssassinEntity extends BaseBritanniaMonster {

    public RatmanAssassinEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "ratman_assassin");
    }
