...
public class AirElementalEntity extends BaseBritanniaMonster {

    public AirElementalEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "elemental_air");
    }
