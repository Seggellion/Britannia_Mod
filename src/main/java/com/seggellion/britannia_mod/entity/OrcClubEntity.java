...
public class OrcClubEntity extends BaseBritanniaMonster {

    public OrcClubEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "orc_club");
    }
