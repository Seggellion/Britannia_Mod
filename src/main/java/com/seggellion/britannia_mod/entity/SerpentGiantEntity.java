...
public class SerpentGiantEntity extends BaseBritanniaMonster {
    ...
    public SerpentGiantEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "serpent_giant");

        // 2. Initialize the parts (No SmoothSwimmingMoveControl needed for ground mobs!)
...
@Override
    ...
    // Attributes (Preserved original Giant Serpent stats)
    ...
    protected void registerGoals() {
        // This naturally pulls in land-based defaults like FloatGoal and RandomStrollGoal
        super.registerGoals(); 
