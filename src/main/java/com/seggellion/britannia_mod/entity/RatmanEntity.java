...
public class RatmanEntity extends BaseBritanniaMonster {

    public RatmanEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "ratman");
    }
