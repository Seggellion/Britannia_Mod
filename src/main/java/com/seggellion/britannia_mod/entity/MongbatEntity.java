...
public class MongbatEntity extends BaseBritanniaMonster {

    public MongbatEntity(EntityType<? extends Monster> entityType, Level level) {
        // Passing "mongbat" automates the loot table, textures, models, animations, AND sounds!
        super(entityType, level, "mongbat");
    }
