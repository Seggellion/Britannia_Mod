...
public class BearPolarEntity extends BaseBritanniaAnimal {

    public BearPolarEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
        super(entityType, level, "bear_polar");
    }
