...
public class BloodElementalEntity extends BaseBritanniaMonster {

    public BloodElementalEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "elemental_blood");
    }
