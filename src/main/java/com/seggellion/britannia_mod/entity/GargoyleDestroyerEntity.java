...
public class GargoyleDestroyerEntity extends BaseBritanniaMonster {

    public GargoyleDestroyerEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "gargoyle_destroyer");
    }
