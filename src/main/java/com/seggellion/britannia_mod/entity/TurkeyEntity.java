...
public class TurkeyEntity extends BaseBritanniaAnimal {

    public TurkeyEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
        super(entityType, level, "turkey");
    }
