...
public class OgreArcticEntity extends BaseBritanniaMonster {

    public OgreArcticEntity(EntityType<? extends Monster> entityType, Level level) {
        // Passing "ogre" automates the loot table, textures, models, animations, AND sounds!
        super(entityType, level, "ogre_arctic");
    }
