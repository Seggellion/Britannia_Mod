...
public class GreatHartEntity extends BaseBritanniaAnimal {

    public GreatHartEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
        super(entityType, level, "great_hart");
    }
