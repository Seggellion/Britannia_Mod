...
public class PoisonElementalEntity extends BaseBritanniaMonster {

    public PoisonElementalEntity(EntityType<? extends Monster> entityType, Level level) {
        super(entityType, level, "elemental_poison");
    }
