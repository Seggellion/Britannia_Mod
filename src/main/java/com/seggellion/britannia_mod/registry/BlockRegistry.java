...
public static final DeferredHolder<Block, ChessBoardBlock> CHESS_BOARD =
    ...
    public static final DeferredHolder<Block, SandstoneWindowBlock> ORNATE_SANDSTONE_WINDOW = BLOCKS.register("ornate_sandstone_window", () -> SandstoneWindowBlock.ornate(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0f).sound(SoundType.STONE).noOcclusion()));
    public static final DeferredHolder<Block, SandstoneWindowBlock> SANDSTONE_WINDOW = BLOCKS.register("sandstone_window", () -> SandstoneWindowBlock.sandstone(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0f).sound(SoundType.STONE).noOcclusion()));
