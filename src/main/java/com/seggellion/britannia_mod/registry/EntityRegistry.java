...
public static final DeferredHolder<EntityType<?>, EntityType<FarmerEntity>> FARMER =
        ENTITIES.register("farmer",
            () -> EntityType.Builder.of(FarmerEntity::new, MobCategory.MISC)
                    .sized(0.6F, 1.95F)
                    .build("britannia_mod:farmer"));
...
public static final DeferredHolder<EntityType<?>, EntityType<FlamingoEntity>> FLAMINGO_ENTITY = ENTITIES.register(
            "flamingo",
            () -> EntityType.Builder.of(FlamingoEntity::new, MobCategory.CREATURE)
                    .sized(0.75F, 1.55F)
                    .clientTrackingRange(8)
                    .build("britannia_mod:flamingo")
    );
...
event.put(BEAR_BROWN_ENTITY.get(), BearBrownEntity.createAttributes().build());
        ...
        event.put(FLAMINGO_ENTITY.get(), FlamingoEntity.createAttributes().build());
      ...
      //  event.put(FISH_MERCHANT_ENTITY.get(), FishTraderEntity.createAttributes().build());
        ...
        event.put(FARMER.get(), FarmerEntity.createAttributes().build());
