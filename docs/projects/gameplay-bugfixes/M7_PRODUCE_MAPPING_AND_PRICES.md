...
Validation and live acceptance are recorded in the main handoff and scratchpad. Read-only production evidence is recorded in M7_PRODUCTION_READONLY_EVIDENCE.md: active Jhelom/Britannia assignment and policy, 15 legacy rows and all 36 new keys absent at 2026-09-07T08:28:11Z. Deployment/new-row/player acceptance remains pending; local fixture evidence is separate.
