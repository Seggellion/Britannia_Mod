...
1. Confirm the definition-specific intake is `READY_FOR_INTEGRATION` and build a development client from the Medium integration commit with operator permission level 2.
